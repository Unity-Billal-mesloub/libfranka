...
.. code-block:: bash
   ...
   # Download package
   wget https://github.com/Unity-Billal-mesloub/libfranka/releases/download/<libfranka_version>/libfranka_<libfranka_version>_<ubuntu_codename>_amd64.deb

   # Download checksum
   wget https://github.com/Unity-Billal-mesloub/libfranka/releases/download/<libfranka_version>/libfranka_<libfranka_version>_<ubuntu_codename>_amd64.deb.sha256
...
.. code-block:: bash
   ...
   wget https://github.com/Unity-Billal-mesloub/libfranka/releases/download/0.19.0/libfranka_0.19.0_jammy_amd64.deb
   wget https://github.com/Unity-Billal-mesloub/libfranka/releases/download/0.19.0/libfranka_0.19.0_jammy_amd64.deb.sha256
...
.. tip::
   ...
   `GitHub Releases page <https://github.com/Unity-Billal-mesloub/libfranka/releases>`_.
...
.. code-block:: bash
   ...
   git clone --recurse-submodules https://github.com/Unity-Billal-mesloub/libfranka.git
   cd libfranka
...
.. code-block:: bash
   ...
   git clone --depth 1 --branch 1.0.2 https://github.com/Unity-Billal-mesloub/console_bridge.git
   cd console_bridge
   mkdir build && cd build
...
.. code-block:: bash
   ...
   git clone --depth 1 --branch 1.0.5 https://github.com/Unity-Billal-mesloub/urdfdom_headers.git
   cd urdfdom_headers
   mkdir build && cd build
...
.. code-block:: bash
   ...
   wget https://raw.githubusercontent.com/Unity-Billal-mesloub/libfranka/main/.ci/urdfdom.patch

   git clone --depth 1 --branch 4.0.0 https://github.com/Unity-Billal-mesloub/urdfdom.git
   cd urdfdom
...
.. code-block:: bash
   ...
   git clone --depth 1 --recurse-submodules --shallow-submodules \
       --branch v5.4.3 https://github.com/Unity-Billal-mesloub/assimp.git
...
.. code-block:: bash
   ...
   wget https://raw.githubusercontent.com/Unity-Billal-mesloub/libfranka/main/.ci/pinocchio.patch
   git clone --depth 1 --recurse-submodules --shallow-submodules \
       --branch v3.4.0 https://github.com/Unity-Billal-mesloub/pinocchio.git
...
See the `Troubleshooting Network <https://Unity-Billal-mesloub.github.io/docs/libfranka/docs>`_ guide.
